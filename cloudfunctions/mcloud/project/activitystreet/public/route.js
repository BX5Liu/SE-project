...
module.exports = {
	...
	'admin/product_insert': 'admin/admin_product_controller@insertProduct',
	'admin/product_detail': 'admin/admin_product_controller@getProductDetail',
	'admin/product_edit': 'admin/admin_product_controller@editProduct',
	'admin/product_update_forms': 'admin/admin_product_controller@updateProductForms',
	'admin/product_del': 'admin/admin_product_controller@delProduct',
	'admin/product_sort': 'admin/admin_product_controller@sortProduct',
	'admin/product_vouch': 'admin/admin_product_controller@vouchProduct',
	'admin/product_status': 'admin/admin_product_controller@statusProduct',
	...
	'admin/bill_insert': 'admin/admin_bill_list_controller@insertBills',
